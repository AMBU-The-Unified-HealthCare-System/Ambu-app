 ...
 * Use the [DriverAppSettingsFragments.newInstance] factory method to
...
class DriverAppSettingsFragments : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DriverAppSettingsFragments.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DriverAppSettingsFragments().apply {
