 ...
 * Use the [AppMainServicesHomeFragment.newInstance] factory method to
...
class AppMainServicesHomeFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AppMainServicesHomeFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AppMainServicesHomeFragment().apply {
